...
urlpatterns = [
    ...
    path("api/v1/objects/", labels.ObjectsView.as_view()),
    path("api/v1/objects/<uuid:pk>/", labels.ObjectView.as_view()),
    path("api/v1/sheets/preview/", labels.SheetPreviewView.as_view()),
